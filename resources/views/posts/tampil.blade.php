            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="{{ asset('storage').'/'.$item->thumbnail }}" alt="img" class="img-thumbnail" style="width: 100px;">
                        </td>
                        <td>{{ $item->title }}</td>
                        ...
                        <td>
                            ...
                            <form action="{{ route('posts.destroy', $item->id) }}" method="POST" class="d-inline delete-form">
                                @csrf
                                @method('DELETE')
